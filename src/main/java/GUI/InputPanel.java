...
public class InputPanel extends FormPanel{
    ...
    InputPanel(){
        ...
        setInfoTextStringPanel(infoTextStringPanel);
        ...
        RSVPButton.addActionListener(e -> {
            if(array != null) {
                ...
                //TODO диалоговое окно неудачи, отмена действия
    ...
    private static void setInfoTextStringPanel(JLabel infoTextStringPanel){
